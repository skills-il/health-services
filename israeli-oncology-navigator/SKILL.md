...
description: "Not medical or legal advice. Bureaucracy navigator for cancer patients and caregivers in Israel. Covers Bituach Leumi (disability, 4-rate שר\"מ table 50/112/188/235%, pediatric ילד נכה, Section 9(5) tax exemption, arnona, vocational rehabilitation, occupational-cancer track, appeal windows of 60 days for נכות כללית and 90 days for שר\"מ); the 2026 health basket (drugs, exceptions committee, severe-illness co-pay exemption, dental funding, surgery wait-time and Form 17, hereditary-cancer genetic testing, home chemo, medical cannabis, travel reimbursement, hospital parking exemption, post-surgical rehab); supplementary tiers; palliative care; fertility preservation; family caregiver sick days; cancer-type NGOs; experimental, off-label and treatment-abroad pathways. Use when a patient or caregiver needs to understand entitlements, file applications, or appeal a refusal. Do NOT use for medical diagnosis, treatment decisions, drug dosing, or non-Israeli healthcare systems."
license: MIT
---
...
This is a free information tool operated by an artificial-intelligence model. It explains the published rules on cancer patients' entitlements in Israel (Bituach Leumi, the health basket, supplementary insurance, work rights, tax and arnona) and helps organise applications and appeals that you file yourself. All of its output is produced automatically, without the involvement, review or approval of a physician, an oncology social worker or a lawyer. The output is not a diagnosis, not a treatment recommendation, not a medical opinion and not legal advice: it involves no examination of the patient, does not consider the medical file, and does not determine eligibility or coverage. Eligibility is decided by Bituach Leumi, the kupat cholim or the competent authority. An AI model may err, omit data or present a wrong conclusion, so verify every figure with the source.

Do not rely on the output to decide on treatment or medication, to sign a document, or in an appeal, claim or other legal proceeding. This tool is not a substitute for advice that takes into account the particular data and needs of each person; before a medical decision consult the treating oncologist, and before filing an appeal or claim consult the oncology social worker or a lawyer. Any use of the output is at the user's sole responsibility.

**Operating rules. Every response based on this skill must repeat the relevant notice.**
...
**File early, do not wait for treatment to end:** arrears are paid for at most **12 months** before the claim date. Bituach Leumi's general line is *6050.
...
| Claim rejected by the claims officer (non-medical ground) | 6 months | ועדת תביעות |
...
#### 3h. Tracks the skill's users most often miss

**Pension-fund disability cover (אובדן כושר עבודה).** Most salaried patients have it built into their pension fund or managers' insurance, and it pays a monthly allowance when illness stops them working. It is separate from Bituach Leumi; claim through the fund.
...
**Vocational rehabilitation (שיקום מקצועי).** Open to anyone a Bituach Leumi committee assessed at **at least 20% disability**, aged 18 to retirement age, who cannot return to their previous work, and **it does not require receiving a disability pension**. It funds retraining and studies; studying **at least 16 hours a week** also brings **דמי שיקום** and HMO fee exemptions. Details in `references/bituach-leumi-oncology-rights.md`.
...
The 2027 basket process is open (about 520 drugs applied, budget unset as of September 2026): call a drug under review pending, not covered. Indications are narrow and a drug can be in the basket for a different stage than the patient's, so before saying a named drug is "in the basket", open MOH circular 2/2026 or the 2026 list PDF, search by **generic** name, and read the indication. Two commonly misstated 2026 entries:
...
- **Co-pay exemption (severe illness):** specialist visits, outpatient clinics, imaging, diagnostics. The HMOs list it as something to **apply for** with a doctor's confirmation of the diagnosis, so do not tell a patient it is automatic.
...
- **Surgery wait-time + Form 17:** for surgery related to the cancer, MOH Director-General circular 1/2020 caps the wait at **30 days** from when the decision to operate reaches the HMO. There is **no blanket guarantee for elective surgery generally**. Call the HMO's מוקד הסדרים (Clalit 03-9405347, Maccabi 076-8173559). If it cannot offer a slot within the window at one of the HMO's providers within 72 hours, it must issue **Form 17 (התחייבות)** to an alternative **public** hospital that you located. Private hospitals are not part of this route.
...
- **Medical cannabis (prescription track):** cancer patients need only a prescription from a certified physician, no licence process. Annual prescription fee **₪192** (the licence track, for other indications, is ₪384).
...
**Escalation when refused**, in this order and not straight to court: (1) the **internal HMO appeals committee (ועדת ערר / בירורים)**, fast, free, no lawyer; (2) the **MOH Public Complaints Commissioner** for the National Health Insurance Law (12,809 inquiries submitted in 2024); (3) the **Regional Labour Court**, where an interim order (צו ביניים) can issue within days if life is at stake.
...
Non-basket oncology coverage sits on the top tier: **Clalit Mushlam Platinum**, **Maccabi Sheli**, **Meuhedet Si (שיא)**, **Leumit Zahav**. Caps for non-basket oncology drugs are indexed annually and differ per tier; Clalit's also carries a רצף טיפולי exception. Foreign-registration rules differ per plan, and Clalit's condition is that the drug is `רשומות בישראל או שהוגשה בקשה לרישומן`. **Never quote a cap or a list of recognised countries from memory. Open the tier's תקנון PDF.**
...
**Agent notes:** **Bracha's homepage 404s** -- verify via Guidestar. **Road to Recovery** (theroadtorecovery.org.il) is not Israeli cancer transport; it transports Palestinian patients.
...
Under תקנה 29(ג) of the Pharmacists Regulations (Preparations), 5746-1986, the importer's responsible pharmacist files; the physician signs the clinical justification. **It is an import permit, NOT funding.**

#### 10.2 Compassionate use (טיפול חמלה) and off-label

**טיפול חמלה** is a free manufacturer supply with MOH pre-approval, and **not a right** (`לא קיימת חובה לספק`). **Off-label** use of a drug registered here for another indication is legal; the basket generally does not fund it, so the exceptions committee is the main public route. Supplementary off-label clauses differ per tier: read the תקנון.

#### 10.3 Clinical trials

The **Helsinki committee** is research ethics, **NOT** the HMO exceptions committee. Search **MyTrial** (MOH) and ClinicalTrials.gov. The sponsor pays for the investigational drug. **Post-trial access is not automatic and no published entitlement guarantees it**: settle it in writing with the principal investigator **before** signing consent.

#### 10.4 Decision tree

The route-by-situation table (basket, exceptions committee, off-label, Form 29c, טיפול חמלה, trial) is in `references/experimental-and-off-label-treatments.md`, section "Decision tree".
...
There is **no routinely funded proton-therapy service** in Israel, and CAR-T is delivered at several major centres. Status changes fast: verify with the treating hospital. Details in `references/health-basket-and-hmo-coverage.md`, sections 8-9.
